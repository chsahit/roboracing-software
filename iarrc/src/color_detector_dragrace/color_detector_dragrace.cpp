...
namespace iarrc {
    class ColorDetectorDrag : public nodelet::Nodelet {
        private:
            Publisher img_pub;
            ...
            virtual void onInit() {
                ...
                ros::Subscriber img_saver_sub = nh.subscribe("/ps3_eye/image_raw", 1, &ColorDetectorDrag::ImageCB, this);
    ...
    PLUGINLIB_DECLARE_CLASS(iarrc, ColorDetectorDrag, iarrc::ColorDetectorDrag, nodelet::Nodelet);
}
